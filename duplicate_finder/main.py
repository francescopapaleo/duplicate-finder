...
def main():
    ...
    compare_parser = subparsers.add_parser("compare", help="Compare two directories for duplicate files.")
    compare_parser.add_argument("reference_folder", help="The reference directory.")
    compare_parser.add_argument("compare_folder", help="The directory to compare with the reference directory.")
    compare_parser.add_argument("--csv_path", default='./', help="Directory where the CSV file will be saved.")
    compare_parser.add_argument("--csv_filename", default='duplicates.csv', help="Name of the CSV file.")
    ...
    scan_parser.add_argument("--csv_path", default='./data', help="Directory where the CSV file will be saved.")
    scan_parser.add_argument("--csv_filename", default='duplicates.csv', help="Name of the CSV file.")

    # Define the 'list' command
    list_parser = subparsers.add_parser("list", help="List duplicates from a CSV file.")
    list_parser.add_argument("csv_file", help="The CSV file that contains the list of duplicates.")

    # Define the 'delete' command
    delete_parser = subparsers.add_parser("delete", help="Delete the duplicate files.")
    delete_parser.add_argument("csv_file", help="The path to the CSV file that contains the list of duplicates to be deleted.")
